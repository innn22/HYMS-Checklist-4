...
<head>
  ...
  <style>
    ...
    /* 썸네일: 칸에 맞게 자동/비율 유지 */
    .thumb{width:110px;height:82px;border:1px solid var(--line);border-radius:8px;object-fit:contain;object-position:center center;background:#fff;cursor:zoom-in;touch-action:manipulation}
